 ...
 */
fun <E> Assert<Iterable<E>>.contains(
    element: E,
    message: (() -> String)? = null,
) {
...
/**
 * Asserts the Iterable does not contain the expected element.
 */
fun <E> Assert<Iterable<E>>.doesNotContain(
    element: E,
    message: (() -> String)? = null,
) {
    if (element in actual) {
...
/**
 * Asserts the Iterable contains all the expected elements.
 */
fun <E> Assert<Iterable<E>>.containsAll(
    vararg elements: E,
    message: (() -> String)? = null,
) {
...
/**
 * Asserts the Iterable contains at least the expected elements.
 */
fun <E> Assert<Iterable<E>>.containsAtLeast(
    vararg elements: E,
    message: (() -> String)? = null,
) {
    val notFound = elements.filter { it !in actual }
...
/**
 * Asserts the Iterable contains only the expected elements (in any order).
 */
fun <E> Assert<Iterable<E>>.containsOnly(
    vararg elements: E,
    message: (() -> String)? = null,
) {
 ...
 */
fun <E> Assert<Iterable<E>>.containsExactlyInAnyOrder(
    vararg elements: E,
    message: (() -> String)? = null,
) {
    val actualList = actual.toList()
...
/**
 * Asserts the Iterable contains none of the expected elements.
 */
fun <E> Assert<Iterable<E>>.containsNone(
    vararg elements: E,
    message: (() -> String)? = null,
) {
 ...
 */
fun <E> Assert<Iterable<E>>.atLeast(
    times: Int,
    message: (() -> String)? = null,
    f: (Assert<E>) -> Unit,
) {
 ...
 */
fun <E> Assert<Iterable<E>>.atMost(
    times: Int,
    message: (() -> String)? = null,
    f: (Assert<E>) -> Unit,
) {
 ...
 */
fun <E> Assert<Iterable<E>>.exactly(
    times: Int,
    message: (() -> String)? = null,
    f: (Assert<E>) -> Unit,
) {
 ...
 */
fun <E> Assert<Iterable<E>>.first(): Assert<E> {
    val element =
        actual.firstOrNull()
 ...
 * Note: This is a transformation method without a message parameter.
 */
fun <E, R> Assert<Iterable<E>>.extracting(f: (E) -> R): Assert<List<R>> = Assert(actual.map(f))
 ...
 * Note: This is a transformation method without a message parameter.
 */
fun <E, R1, R2> Assert<Iterable<E>>.extracting(
    f1: (E) -> R1,
    f2: (E) -> R2,
